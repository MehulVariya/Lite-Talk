    ...
    class ContactAdapter(items: MutableList<ContactDTO>, ctx: Context, groupID: String) :
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.contact_card_view.setOnClickListener {
                ...
                val def = FirebaseDatabase.getInstance().getReference("Users Details").child(fetch_number)
                    .addValueEventListener(object : ValueEventListener {
                        override fun onDataChange(snapshot: DataSnapshot) {
                            if (snapshot.exists()){

//                                val reference = FirebaseDatabase.getInstance().getReference("Groups")
//                                reference.child(groupID).child("Participants").orderByKey()
//                                    .addValueEventListener(object : ValueEventListener {
//                                        override fun onDataChange(snapshot: DataSnapshot) {
////                                            for (ds in snapshot.children){
////                                                phone=""+ds.child("uid").value
////                                                if (phone == fetch_number){
...
//                                    })
                                ...
                                if (fetch_number == fetch_phone_number){
                                    ...
                                    ref.child(groupID).child("Participants").orderByChild("uid").equalTo(fetch_phone_number).addValueEventListener(object :ValueEventListener{
                                        override fun onDataChange(snapshot: DataSnapshot) {
                                            for (ds in snapshot.children){
...
//                                    //not exists/not participant-add
                                ...
                                intent_id.putExtra("pass_receiver_name", contact_model.contact_name.trim())
