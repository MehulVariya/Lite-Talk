...
import com.group_project.chatapplication.chatbot.ChatBotActivity;
...
//                startActivity(new Intent(MainActivity.this, Contact_Show_Activity.class));
        ...
        btnChatBot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent_id = new Intent(MainActivity.this, ChatBotActivity.class);
                intent_id.putExtra("myMobileNo", Objects.requireNonNull(user.getPhoneNumber()).replace("+91", ""));
        ...
        getSupportActionBar().setTitle("Lite Talk");
